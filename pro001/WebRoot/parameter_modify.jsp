		...
		<table width="778" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td valign="top" bgcolor="#FFFFFF">
					<table width="99%" height="510" border="0" align="center"
						cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
						class="tableBorder_gray">
						<tr>
							<td height="510" valign="top" style="padding: 5px;">
								<table width="98%" height="487" border="0" cellpadding="0"
									cellspacing="0">
									<tr>
										...
										<td align="center" valign="top">
											...
											<form name="form1" method="post"
												...
												<table width="43%" border="0" cellpadding="0"
													...
													<tr align="center">
														<td width="24%" align="left" style="padding: 5px;">
															办证费：
														</td>
													...
													<tr>
														...
														<td align="left">
															<input name="validity" type="text" id="validity"
																size="30" value="<%=validity%>">
															(月)
														</td>
													</tr>
													<tr>
